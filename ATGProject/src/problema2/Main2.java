...
public class Main2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("             Existem relacoes entre os vertices quando um eh menor que o outro. As arestas tem peso dado pela diferenca entre a experiencia dos vertices.");
